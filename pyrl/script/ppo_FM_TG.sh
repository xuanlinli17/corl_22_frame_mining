python tools/run_rl.py configs/mfrl/ppo/maniskill/maniskill_tf_frame_pn_late_state.py --gpu-ids 0 --work-dir=./FM-TG-Movebucket --cfg-options \
...
'agent_cfg.actor_cfg.optim_cfg.lr=1e-4' 'agent_cfg.critic_cfg.optim_cfg.lr=3e-4' \
